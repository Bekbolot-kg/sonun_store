...
class Sonun_Store(models.Model):
    ...
    status = models.CharField('Статус', max_length=20,
                              choices=(('В наличии', 'В наличии'),
                                       ('Распродано', 'Распродано')), null=True)
...
class Reviews(models.Model):
    name_reviews = models.ForeignKey(Sonun_Store, on_delete=models.CASCADE,
                                     related_name='comment_object', null=True)
